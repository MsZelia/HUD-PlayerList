package
{
   ...
   [Embed(source="/_assets/assets.swf", symbol="symbol1807")]
   public class DamageNumbers extends MovieClip
   {
      ...
      public function UpdateItem(param1:int, param2:Number, param3:Number) : Boolean
      {
         ...
         {
            if((_loc5_ = _loc4_ as DamageNumberClip) != null && _loc5_.UniqueId == param1)
            {
      ...
      {
         var _loc8_:DamageNumberClip;
         (_loc8_ = new DamageNumberClip()).ParentObj = this;
