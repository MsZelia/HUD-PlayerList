package
{
   ...
   public class HUDCurrencyUpdatesWidget extends MovieClip
   {
      ...
      public static const FRAME_BEGIN:String = "rollOn";
      
      public static const FRAME_ROLL:String = "rollNumber";
      
      public static const FRAME_FADEOUT:String = "rollOut";
      
      public static const TYPE_GENERIC:uint = 0;
      
      public static const TYPE_KILL:uint = 1;
      
      public static const BREAKDOWN_LINES:uint = 3;
      
      public static const EVENT_PULL:String = "Currency::DiscardTransaction";
      ...
      private function evaluateQueue() : void
      {
         ...
         if(!this.m_IsBusy)
         {
            ...
            if(_loc1_.length > 0)
            {
               ...
               {
                  (_loc5_ = new MergedTransaction()).currencyType = _loc3_;
...
class MergedTransaction
{
   ...
   public function MergedTransaction()
   {
      super();
   }
